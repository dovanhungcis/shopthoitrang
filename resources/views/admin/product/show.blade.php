...
<div class="page-title">
	<h2>
		<span class="fa fa-arrow-circle-o-left"></span> Products
	</h2>
						...
						<div class="table-responsive">
							<div id="DataTables_Table_0_wrapper"
								...
								<a href="{{route('admin@product@create')}}"
									class="btn btn-warning btn-xs pull-right"> <h7>+ Products</h7>
								</a>
								<table class="table dataTable no-footer"
									...
									<thead>
										<tr role="row" style="">
											...
											<th class="sorting_asc" style="width: 50px;">Quantity</th>
											<th class="sorting_asc" style="width: 50px;">Sold</th>
									...
									<tbody>
										...
										<tr role="row" class="odd">
											...
											<td class="sorting_1"><a href="{{route('admin@productquantity@show',$row->id)}}">{{$row->name}}</a></td>
											<td class="sorting_1">{{$row->quantity}}</td>
											<td class="sorting_1">{{$row->sold}}</td>
											<td><a href="{{route('admin@product@edit',$row->id)}}"
												class="label label-primary">Edit</a><a
												onclick="return myFunction();"
												href="{{ route('admin@product@destroy',$row->id) }}"
