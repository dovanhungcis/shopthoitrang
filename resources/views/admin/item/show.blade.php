@extends('admin.template') @section('title', 'Item')
@section('content')
<!-- START BREADCRUMB -->
<ul class="breadcrumb">
...
<div class="page-title">
	<h2>
		<span class="fa fa-arrow-circle-o-left"></span> Item
	</h2>
						...
						<div class="table-responsive">
							<div id="DataTables_Table_0_wrapper"
								...
								<a href="{{route('admin@item@create')}}"
									class="btn btn-warning btn-xs pull-right"> <h7>+ Item</h7>
								</a>
								<table class="table dataTable no-footer"
									...
									<tbody>
										...
										<tr role="row" class="odd">
											...
											<td><a href="{{route('admin@item@edit',$row->id)}}"
												class="label label-primary">Edit</a><a
												onclick="return myFunction();"
												href="{{ route('admin@item@destroy',$row->id) }}"
