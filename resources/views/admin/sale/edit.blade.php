	...
	<div class="row">
		<div class="col-md-12">
			<form class="form-horizontal"
				action="{{ route('admin@sale@update',$sale->id) }}"
						...
						<div class="form-group">
							...
							<div class="col-md-10 col-xs-12">
								<div class="input-group">
									...
									<input type="text" class="form-control datepicker" name="start_date" value="{{$sale->start_date}}" >
								</div>
								<span class="help-block"></span>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-10 col-xs-12">
								<div class="input-group">
									...
									<input type="text" class="form-control datepicker" name="end_date" value="{{$sale->end_date}}" >
								</div>
								<span class="help-block"></span>
							</div>
						</div>
