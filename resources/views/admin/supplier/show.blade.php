@extends('admin.template') @section('title', 'Suppliers')
@section('content')
<!-- START BREADCRUMB -->
<ul class="breadcrumb">
...
<div class="page-title">
	<h2>
		<span class="fa fa-arrow-circle-o-left"></span> Suppliers
	</h2>
						...
						<div class="table-responsive">
							<div id="DataTables_Table_0_wrapper"
								...
								<a href="{{route('admin@supplier@create')}}"
									class="btn btn-warning btn-xs pull-right"> <h7>+ Supplier</h7>
								</a>
								<table class="table dataTable no-footer"
									...
									<tbody>
										...
										<tr role="row" class="odd">
											...
											<td><img
												src="{{asset('/admin1/assets/uploads/suppliers/'.$row->photo)}}"
												class="img-thumbnail" style="min-width: 150px; max-width:100px;"></td>
											<td><a href="{{route('admin@supplier@edit',$row->id)}}"
												class="label label-primary">Edit</a><a
												onclick="return myFunction();"
												href="{{ route('admin@supplier@destroy',$row->id) }}"
